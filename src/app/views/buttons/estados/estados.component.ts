...
getData(): void {
  ...
  const url = 'https://hela.transyanez.cl/api/reportes/resumenHoraProductos';
...
getClientesEntregas(): void {
  const url = 'https://hela.transyanez.cl/api/reportes/Cliente-Png-entregas';
...
Count:  any[] = [];
getCount(): void {
  const url = 'https://hela.transyanez.cl/api/reportes/Count';
