...
@Component({
  selector: 'app-prefactura-mensual',
  templateUrl: './prefactura-mensual.component.html',
  styleUrls: ['./prefactura-mensual.component.scss']
})
export class PrefacturaMensualComponent {
  ...
  uploadFile() {
    if (this.selectedFile) {
      ...
      this.service.subirExcelPrefacturaMensual(formData, id_usuario,ids_usuario).subscribe(
        (data : any) => {
