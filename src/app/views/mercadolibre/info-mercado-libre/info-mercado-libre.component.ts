...
@Component({
  selector: 'app-info-mercado-libre',
  templateUrl: './info-mercado-libre.component.html',
  styleUrls: ['./info-mercado-libre.component.scss']
})
export class InfoMercadoLibreComponent {
  ...
  uploadFile() {
    if (this.selectedFile) {
      ...
      //Syntax para Subir datos mediante api
