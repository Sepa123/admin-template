...
export class TestComponent {
  ...
  pendienteseOpl(){
    ...
    this.subPedido = this.service.pendientes_opl(this.fecha_inicio,this.fecha_fin,"0").subscribe((data) => {
  ...
  retiroTienda(){
    ...
    this.subPedido = this.service.pendientes_retiro_tienda(this.fecha_inicio,this.fecha_fin,"0").subscribe((data) => {
      // console.log(data.length);
      if (data.length === 0) {
        cantActual = 0
        this.isLoadingTable = false
