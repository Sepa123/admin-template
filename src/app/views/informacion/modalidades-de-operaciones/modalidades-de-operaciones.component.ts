...
@Component({
  ...
  styleUrls: ['./modalidades-de-operaciones.component.scss','./modalidades-de-operaciones2.component.scss','./modalidades-de-operaciones3.component.scss'],
})
...
getTiposVehiculo() {
  ...
  this.http.get<any[]>('https://hela.transyanez.cl/api/operacion/tipo-vehiculo/')
    .subscribe(
      data => {
...
deleteTipoVehiculo(id: number): Promise<void> {
  return fetch(`https://hela.transyanez.cl/api/operacion/delete-tipo-vehiculo/${id}`, {
    method: 'DELETE'
  })
    .then(response => {
      if (!response.ok) {
...
getDataTipoVehiculo(id : number) {
    // https://hela.transyanez.cl
  this.isLoading = true;
  this.http.get<any[]>('https://hela.transyanez.cl/api/operacion/op-tipo-vehiculo/?id_operacion=' + id)
    .subscribe(
      data => {
...
agregarTipoVehiculo() {
  ...
  // https://hela.transyanez.cl
  this.http.post('https://hela.transyanez.cl/api/operacion/agregar-tipo-vehiculo/', body)
    .subscribe(
      (resp: any) => {
