...
export const ROLES_PERMITIDOS = {
    ...
    INFORMACION : [ROLES_ENUM.ADMIN, ROLES_ENUM.JEFE_OPERACIONES,ROLES_ENUM.COORDINADOR],
    ...
    INFORMACION_OPERACIONES : [ROLES_ENUM.JEFE_OPERACIONES, ROLES_ENUM.COORDINADOR, ROLES_ENUM.SUPERVISOR],
