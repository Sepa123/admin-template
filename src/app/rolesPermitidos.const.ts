...
export const ROLES_PERMITIDOS = {
    ...
    PICKING : [ROLES_ENUM.ADMIN, ROLES_ENUM.JEFE_OPERACIONES,ROLES_ENUM.COORDINADOR, ROLES_ENUM.RAUDDY,ROLES_ENUM.RUT_PICKEADOR, ROLES_ENUM.TRANSPORTE,  ROLES_ENUM.JEFE_TOC],
