...
export const ROLES_PERMITIDOS = {
    ...
    INFORMACION : [ROLES_ENUM.ADMIN, ROLES_ENUM.JEFE_OPERACIONES,ROLES_ENUM.COORDINADOR, ROLES_ENUM.RAUDDY, ROLES_ENUM.TOC, ROLES_ENUM.JEFE_TOC, ROLES_ENUM.TRANSPORTE , ROLES_ENUM.JEFE_TRANSPORTE, ROLES_ENUM.SEGURIDAD],
    ...
    INFORMACION_SEGURIDAD : [ROLES_ENUM.SEGURIDAD],
