...
export const ROLES_PERMITIDOS = {
    ...
    OPERACIONES : [ROLES_ENUM.ADMIN, ROLES_ENUM.JEFE_OPERACIONES,ROLES_ENUM.COORDINADOR, ROLES_ENUM.TOC, ROLES_ENUM.JEFE_TOC, ROLES_ENUM.TRANSPORTE,ROLES_ENUM.RAUDDY, ROLES_ENUM.ANALISTA_EXO, ROLES_ENUM.JEFE_TRANSPORTE],
    ...
    PICKING : [ROLES_ENUM.ADMIN, ROLES_ENUM.JEFE_OPERACIONES,ROLES_ENUM.COORDINADOR, ROLES_ENUM.RAUDDY,ROLES_ENUM.RUT_PICKEADOR, ROLES_ENUM.TRANSPORTE,  ROLES_ENUM.JEFE_TOC, ROLES_ENUM.JEFE_TRANSPORTE],
    PICKING_ALL : [ROLES_ENUM.ADMIN, ROLES_ENUM.JEFE_OPERACIONES,ROLES_ENUM.COORDINADOR, ROLES_ENUM.RAUDDY,ROLES_ENUM.TRANSPORTE],
    PICKING_RUT_PICKIEADOR : [ROLES_ENUM.RUT_PICKEADOR, ROLES_ENUM.JEFE_TOC],
    OPL  : [ROLES_ENUM.ADMIN],
    TOC : [ROLES_ENUM.ADMIN,ROLES_ENUM.JEFE_TOC,ROLES_ENUM.TOC, ROLES_ENUM.TRANSPORTE,ROLES_ENUM.JEFE_OPERACIONES,ROLES_ENUM.COORDINADOR, ROLES_ENUM.JEFE_TRANSPORTE],
    ...
    INFORMACION : [ROLES_ENUM.ADMIN, ROLES_ENUM.JEFE_OPERACIONES,ROLES_ENUM.COORDINADOR, ROLES_ENUM.RAUDDY, ROLES_ENUM.TOC, ROLES_ENUM.JEFE_TOC, ROLES_ENUM.TRANSPORTE , ROLES_ENUM.JEFE_TRANSPORTE],
    ...
    ONLY_ALERTAS_TOC :[ROLES_ENUM.TRANSPORTE,ROLES_ENUM.JEFE_OPERACIONES,ROLES_ENUM.COORDINADOR, ROLES_ENUM.JEFE_TRANSPORTE],
    ...
    RSV_ALL : [ROLES_ENUM.ADMIN, ROLES_ENUM.SUPERVISOR_RSV,'fabian.lara@transyanez.cl','jp@gmail.com'],
