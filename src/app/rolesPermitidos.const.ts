...
export const ROLES_PERMITIDOS = {
    ...
    RSV : [ROLES_ENUM.ADMIN, ROLES_ENUM.CLIENTE_RSV,ROLES_ENUM.OPERARIO_RSV, ROLES_ENUM.ADMINISTRATIVO_RSV,ROLES_ENUM.SUPERVISOR_RSV],
    RSV_ALL : [ROLES_ENUM.ADMIN, ROLES_ENUM.ADMINISTRATIVO_RSV],
